...
class Receiver(object):
    ...
    def insertInbox(self, body):
        query = "INSERT INTO inbox(`query`, `table`, `pk`, `type`, `timestamping`, `id_sender`, `sender_name`) "
        query += "VALUES (\"%s\", '%s', '%s', '%s', '%s', '%s', '%s')" % (body["query"], body["table"], body["pk"], body["type"], body["timestamping"], body["id_sender"], body["sender_name"])
